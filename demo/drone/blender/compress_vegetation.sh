...
# Usage from anywhere:     bash demo/drone/blender/compress_vegetation.sh
...
RAW_GLB="$DRONE_DIR/assets/blender/vegetation.glb"
COMPRESSED_GLB="$DRONE_DIR/assets/compressed/vegetation.glb"
